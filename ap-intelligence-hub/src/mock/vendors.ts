  ...
  },
  {
    ...
    contracts: [
      ...
      },
      {
        ...
        category: 'DELIVERY_INSTALLATION' as const,
  ...
  // --- D&I CONTRACTORS ---
  {
    ...
    contracts: [
      ...
      },
      {
        ...
        category: 'FREIGHT_FINISHED_GOODS' as const,
        startDate: '2024-06-01',
        endDate: '2027-05-31',
        maxAmount: 1500000,
        isActive: true,
...
export const mockExtractionTemplates = [
  {
    ...
    description: 'Template for extracting data from subcontractor invoices',
  ...
  {
    id: 'EXT-002',
    name: 'D&I Work Completion Certificate',
    description: 'Template for extracting data from delivery & installation job completion and billing documents',
  ...
  },
  {
    ...
    description: 'Template for extracting data from freight and shipping invoices',
    category: 'FREIGHT_FINISHED_GOODS',
    fields: [
...
export const mockInvoiceCategoryConfigs = [
  {
    ...
    description: 'Subcontractor service invoices for maintenance, repairs, and installations',
  ...
  {
    id: 'ICAT-002',
    category: 'RUST_SUBCONTRACTOR',
    name: 'Rust - Subcontractor Invoices',
    description: 'Subcontractor invoices for rust-related repair work with chargeable components',
    defaultGLAccount: '500200',
    defaultCostCenter: 'CC1002',
    requiresPO: true,
    requiresGRN: false,
    autoMatchEnabled: true,
    tolerancePercent: 5,
  ...
  },
  {
    id: 'ICAT-003',
    category: 'DELIVERY_INSTALLATION',
    name: 'Delivery & Installation Invoices',
    description: 'Equipment delivery, installation, and setup invoices',
    defaultGLAccount: '500300',
  ...
  },
  {
    id: 'ICAT-004',
    category: 'FREIGHT_FINISHED_GOODS',
    name: 'Freight - Finished Goods',
    description: 'Sea and air freight invoices for finished goods shipments',
    defaultGLAccount: '510100',
  ...
  {
    id: 'ICAT-005',
    category: 'FREIGHT_SPARE_PARTS',
    name: 'Freight - Spare Parts',
    description: 'Freight invoices for spare parts shipments',
    defaultGLAccount: '510200',
    defaultCostCenter: 'CC1008',
    requiresPO: false,
    requiresGRN: false,
    autoMatchEnabled: true,
    tolerancePercent: 10,
  ...
  {
    id: 'ICAT-006',
    category: 'FREIGHT_ADDITIONAL_CHARGES',
    name: 'Freight - Additional Charges',
    description: 'Additional freight charges: demurrage, storage, customs, handling fees',
    defaultGLAccount: '510300',
    defaultCostCenter: 'CC1009',
    requiresPO: false,
    requiresGRN: false,
    autoMatchEnabled: false,
    tolerancePercent: 15,
